        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/homelogo.jpg" alt="" /></a>
            </div> 
          </div>
          <div class="col-md-8 clearfix">
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                <li><a href="<?php echo web_root;?>index.php?q=cart" style="font-size: 1.3em;"><i class="fa fa-shopping-cart" ></i> Cart</a></li>
                <?php if (isset($_SESSION['CUSID'] )) { ?>  
                  <li><a href="<?php echo web_root?>index.php?q=profile" style="font-size: 1.3em;"><i class="fa fa-user"></i> Account</a></li>     
                  <li><a   href="<?php echo web_root?>logout.php" style="font-size: 1.3em;"><i class="fa fa-lock"></i> Logout</a></li>
                <?php }else{ ?> 
                <li><a data-target="#smyModal" data-toggle="modal"  href="" style="font-size: 1.3em;"><i class="fa fa-lock"></i> Login</a></li>
              <?php } ?>
              </ul>
            </div>
          </div>
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                <li><a href="<?php echo web_root;?>" class="active" style="font-size: 1.5em;">Home</a></li>
                <li class="dropdown"><a href="#" style="font-size: 1.5em;">Available<i class="fa fa-angle-down"></i></a>
                ...
                <li><a href="<?php web_root?>index.php?q=product" style="font-size: 1.5em;">Products</a></li>
                <li><a href="<?php web_root?>index.php?q=contact" style="font-size: 1.5em;">About Us</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              <h2>About Us</h2>
              <ul class="nav nav-pills nav-stacked">
                <li><a href="<?php web_root?>index.php?q=contact">Company Information</a></li>
              </ul>
            </div>
          </div>
