          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>KGB</span>-SHOP</h1>
                  <h2>Free Delivery on Everything</h2>
                  <p>No shipping fee within the Philippines only </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/kiez.jpg" class="girl img-responsive" alt="" />
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>KGB</span>-SHOP</h1>
                  <h2>Fast Delivery</h2>
                  <p>Delivered within 1-2 days depending on your location </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/gelo.jpg" class="girl img-responsive" alt="" />
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>KGB</span>-SHOP</h1>
                  <h2>Best Quality</h2>
                  <p>Discover unparalleled quality with our products. </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/nix.jpg" class="girl img-responsive" alt="" />
      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center">Available Items/Services  </h2>
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <h4><?php  echo    $result->PRODESC; ?></h4>
                      <h6><i>Stock: <?php  echo    $result->PROQTY; ?></i></h6>
                    </div>
       ...
       <?php  } ?>
          ...
          <div class="recommended_items">
            <h2 class="title text-center">recommended items/services</h2>
