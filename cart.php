...
?>
             ...
             ';
                                  ...
                                  <td class="input-group custom-search-form" >
                                       ...
                                       <input type="number" min="0" data-id="<?php echo $result->PROID; ?>" class="QTY form-control input-sm" autocomplete="off" id="QTY<?php echo $result->PROID; ?>" name="QTY<?php echo $result->PROID; ?>" value="<?php echo max(0, $_SESSION['gcCart'][$i]['qty']); ?>" placeholder="Search for...">
                            ...
                            <?php  
                                ...
                                echo '<div style="text-align: center;"><h3>There is no item in the cart.</h3></div>';
                               } 
                            ?>  
